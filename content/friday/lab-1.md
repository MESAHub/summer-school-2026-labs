...
**Eb!**: can you check that what i wrote here is correct?
...
**Eb!**: hey i'm sorry but here is probably where I need your help the most...Basically I am not sure how lynn wanted to finish this part of the exercise and something that the testers pointed out is that there is no instruction to either restart or run the simulation. I think we need to restart it, but it's not super clear to me how lynn wanted it to be done :(

Also, did either you or lynn sort out why the lab is not crashing? is it a folder issue or something different?
...
**Eb!**: can you please have a look at the picture and check that the paragraph I wrote about the blue loop makes sense please? :)


{{< details title="What is a **Blue Loop**?" closed="true" >}}
In this figure you can see how the evolution of the star looks like on the Hertzsprung-Russell diagram (HRD). Did you notice that the track crosses the boundaries of the Instability Strip 2 times in a row?

This is what is called a **Blue Loop**, a stage during the evolution of intermediate mass stars that happens during Helium burning. On the HRD it looks like a horizontal "deviation" of the track from the Red Giant Branch towards higher temperatures, thus making the star appear _more blue_.

During this phase the stars become unstable and usually undergo radial pulsations. However, not all the stars in the intermediate mass range come across a blue loop during their evolution.

Indeed, there are multiple factors that can either prevent its appearance, such as internal mixing (convective overshooting), chemical composition (metallicity) or nuclear reactions.

If you wanna know more about this, have a look at [this paper](https://ui.adsabs.harvard.edu/abs/2026ApJS..284...60S/abstract)!
