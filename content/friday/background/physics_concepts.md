...
- **red edge selection**: the Lab 3 starting models are chosen visually about 10-30% of the plotted instability strip width in from the red edge. This is a qualitative HR diagram guide, not a formal temperature criterion, and helps favor fundamental mode nonlinear behavior without sitting exactly on the edge of stability.
